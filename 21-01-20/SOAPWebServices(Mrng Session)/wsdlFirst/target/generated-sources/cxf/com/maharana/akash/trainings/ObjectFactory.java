 ...
 * generated in the com.maharana.akash.trainings package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrdersRequest_QNAME = new QName("http://trainings.akash.maharana.com/", "getOrdersRequest");
    private final static QName _GetOrdersResponse_QNAME = new QName("http://trainings.akash.maharana.com/", "getOrdersResponse");
    private final static QName _CreateOrdersRequest_QNAME = new QName("http://trainings.akash.maharana.com/", "createOrdersRequest");
    private final static QName _CreateOrdersResponse_QNAME = new QName("http://trainings.akash.maharana.com/", "createOrdersResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.maharana.akash.trainings
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://trainings.akash.maharana.com/", name = "getOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://trainings.akash.maharana.com/", name = "getOrdersResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://trainings.akash.maharana.com/", name = "createOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://trainings.akash.maharana.com/", name = "createOrdersResponse")
